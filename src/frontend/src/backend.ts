...
export class Backend implements backendInterface {
    ...
    async getDailyLeaderboard(): Promise<Array<GameScore>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyLeaderboard();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLeaderboard(): Promise<Array<GameScore>> {
        if (this.processError) {
            try {
    ...
    async submitScore(arg0: bigint, arg1: bigint, arg2: Array<string>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async unlockPerk(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unlockPerk(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
